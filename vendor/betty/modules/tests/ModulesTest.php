...
class ModulesTest extends PHPUnit_Framework_TestCase {
    ...
    {
        $this->finder = m::mock('Betty\Modules\Finder');
    ...
    {
        $this->assertInstanceOf('Betty\Modules\Module', $this->module);
    }
    ...
    {
        $this->setExpectedException('Betty\Modules\Exceptions\FileMissingException');
        throw new Betty\Modules\Exceptions\FileMissingException;
    }
